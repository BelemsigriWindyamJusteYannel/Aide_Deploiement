    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participation_mode', models.CharField(blank=True, max_length=100, verbose_name='Mode de participation')),
                ('position', models.CharField(blank=True, max_length=100, verbose_name='Poste ou fonction')),
                ('organization', models.CharField(blank=True, max_length=200, verbose_name='Organisation')),
                ('interest_domain', models.CharField(blank=True, max_length=200, verbose_name='Domaine d’intérêt')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
            options={
